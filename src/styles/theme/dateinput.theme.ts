...
const basedisabled= "disabled:cursor-default disabled:bg-silver-200"
const basefocus= "focus:border-natural-900"
const baseAfter = `
after:content-['']
...
after:bg-contain
after:bg-date
disabled:after:cursor-default
disabled:after:opacity-65
`

const DatepickerConfig: DatepickerStyle = {
    base: `
        select-none
        relative
